...
public class InterstitialAdForVideoAppActivity extends Activity {
    ...
    private LayoutParams reLayoutParams;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reLayoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    private void createQianTiePianAd() {
        String adPlaceId = "2652535"; // 重要：请填上您的广告位ID
